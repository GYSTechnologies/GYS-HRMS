...
//       { label: "Leaves", path: "/hr/leaves", icon: FileText },
...
//   return (
//     <div className="bg-white shadow-lg w-80 min-h-screen flex flex-col">
//       {/* Header */}
...
//               <>
//                 <div className="font-semibold text-gray-800 text px-1">
  ...
  return (
    <div className="bg-white shadow-lg w-80 min-h-screen flex flex-col">
      <button
        ...
        className="absolute top-7 right-20 lg:hidden text-gray-600 hover:text-gray-900"
      >
        ✕
      </button>
