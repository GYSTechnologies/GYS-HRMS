...
const Sidebar = ({ closeSidebar }) => {
  ...
  const menuItems = {
    admin: [
      { label: "Dashboard", path: "/admin", icon: BarChart3 },
      { label: "Manage Employees", path: "/admin/manage-employees", icon: Users },
      { label: "Attendance Management", path: "/admin/attendance", icon: Clock },
  ...
  return (
    <div
      ref={sidebarRef}
      className="bg-white shadow-lg w-60 sm:w-60 lg:w-72 min-h-screen flex flex-col relative transition-all duration-200"
    >
      {/* Header */}
      <div className="px-3 py-2 border-b border-gray-100 flex items-center justify-between">
        <div className="flex items-center min-w-0 flex-1">
